...
let achievements = [
    {
        description: 'Achievement Unlocked: Förgörnings Kombo',
        requiredUpgrades: 10,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Så börjar det...',
        money: 1,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Dödlig sjukdom',
        money: 10000,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Förgör mänskligheten',
        money: 100000,
        acquired: false,
    },
    {
    description: 'Achievement Unlocked: Gör det...',
    money: 20000000,
    acquired: false,
},
];
...
upgrades = [
    {
        name: 'Automatiska råttor',
        cost: 10*2,
        amount: 1*1.5,
    },
    {
        name: 'Dödligare bakterier',
        cost: 50*2,
        clicks: 2*1.5,
    },
    {
    ...
    {
        name: 'Multiplicerande bakterier',
        cost: 26000*2,
        clicks: 100*1.5,
    },
    {
        name: 'Multiplicerande råttor',
        cost: 45000*2,
        amount: 20000*1.5,
    },
    {
        name: 'Ta bort immunitet',
        cost: 4300000*2,
        amount: 130000*1.5,
    },
    {
