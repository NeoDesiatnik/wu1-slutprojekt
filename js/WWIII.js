...
let costmultiplier = 6;
let effectmultiplier = 3.5;
...
let achievements = [
    {
        description: 'Achievement Unlocked: Du är en galen man.',
        requiredUpgrades: 10,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Är det här en bra ide?',
        money: 1,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Det är inte för sent att vända om!',
        money: 10000,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Det här går väl bra.. eller?',
        money: 100000,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Slutet är nära...',
        money: 30000000,
        acquired: false,
    },
];
...
upgrades = [
    ...
    {
        name: 'Permanent Kärnvinter',
        cost: 15000000*costmultiplier,
        url: "https://www.blackscreen.app"
    },
];
...
function createCard(upgrade) {
    ...
    cost.textContent = `Köp för ${upgrade.cost} tragedier.`;
