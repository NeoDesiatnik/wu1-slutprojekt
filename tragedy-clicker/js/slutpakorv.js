...
let costmultiplier = 5;
let effectmultiplier = 3;
...
let achievements = [
    {
        description: 'Achievement Unlocked: Din första medhjälpare',
        requiredUpgrades: 10,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Detta är bara början',
        money: 1,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: "THEY HAVE HIT THE NORTH TOWER"',
        money: 10000,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: Tornen är nere',
        money: 100000,
        acquired: false,
    },
    {
        description: 'Achievement Unlocked: The Pentagon',
        money: 30000000,
        acquired: false,
    },
];
